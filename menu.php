...
<h1>Bienvenue dans l’application Théâtre !</h1>
      ...
      <h2>  QUESTIONS A FAIRE </h2>
      <ul class="menu">
        <li><a href="DetailsRepresentation.php"> Q1 - Detail de Representation des Spectacles </a></li>
        <li><a href="CategorieTicket.php"> Q2 - Categorie des tickets </a></li>
      </ul>
